        ...
        if(Alpha>=0 && Beta>=0 && Gamma >=0)
            ...
            if(depth < Z_buffer(j,i))
               ...
               % fetching texture color from Texture_unit0
                [red_val  , dec] = Texture_unit_LoD_MIP_Tri(image(:,:,1), GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T, Grad_Buff, counter_state, GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER);
                [green_val,] = Texture_unit_LoD_MIP_Tri (image(:,:,2), GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T, Grad_Buff, counter_state, GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER);
                [blue_val ,] = Texture_unit_LoD_MIP_Tri (image(:,:,3), GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T, Grad_Buff, counter_state, GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER);
