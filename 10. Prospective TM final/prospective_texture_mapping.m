...
ss = input('Texture size= ');
image_1 = Texture_gen(ss, 1);
...
[frame_buffer,z_buffer] = tri_scan_conv_Z_text_pros( a(1:3)', c(1:3)',b(1:3)' ,ah, ch, bh, frame_buffer, z_buffer ,cc,aa,dd,image_1, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T);
% second triangle (left)
[frame_buffer,z_buffer] = tri_scan_conv_Z_text_pros( d(1:3)', c(1:3)',b(1:3)' ,dh, ch, bh,  frame_buffer, z_buffer ,bb,aa,dd,image_1, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T);
