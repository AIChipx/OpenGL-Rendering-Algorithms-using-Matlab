...
image_1 = double(imread('chess2.png'))/255;
...
[frame_buffer,z_buffer] = tri_scan_conv_Z_text_pros2( a(1:3)', c(1:3)',b(1:3)', frame_buffer, z_buffer ,cc,aa,dd,image_1, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T);
% second triangle (left)
[frame_buffer,z_buffer] = tri_scan_conv_Z_text_pros2( d(1:3)', c(1:3)', b(1:3)', frame_buffer, z_buffer ,bb,aa,dd,image_1, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T);

% % first triangle (right) 
% [frame_buffer] = tri_scan_conv_text( a(1:3)', c(1:3)',b(1:3)', frame_buffer ,cc,aa,dd,image_1, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T);
% % second triangle (left)
% [frame_buffer] = tri_scan_conv_text( d(1:3)', c(1:3)', b(1:3)', frame_buffer ,bb,aa,dd,image_1, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T);
