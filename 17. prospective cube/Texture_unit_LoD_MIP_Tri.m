function [ color, decision ] = Texture_unit_LoD_MIP_Tri (texture_image, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T, Grad_Buff, counter_state,GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER )
