function [ frame_out, decision_out ] = tri_scan_conv_Z_text_pros_LoD( x1, y1, z1, h0, h1, h2, Frame_buffer ,aa,bb,cc,image, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T, GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER, decision, k )
...
%             if(depth < Z_buffer(j,i))
               ...
               % fetching texture color from Texture_unit0
                [gray_val  , dec] = Texture_unit_LoD_MIP_Tri(image(:,:,1), GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_T, Grad_Buff, counter_state, GL_TEXTURE_MAG_FILTER, GL_TEXTURE_MIN_FILTER ,k);
                
                % updating the frame buffer
                Frame_buffer(j,i) = gray_val;
