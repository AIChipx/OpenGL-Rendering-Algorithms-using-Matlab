...
%image_1 = double(imread('Burn_icon.png'))/255;

[image11, map, alpha] = imread('moss_128.png');
%[image11, map, alpha] = imread('Ibn_128.png');
...
[frame_buffer,z_buffer, alpha_ch] = tri_scan_conv_Z_text_pros( a(1:3)', c(1:3)',b(1:3)' ,ah, ch, bh, frame_buffer, z_buffer ,alpha_ch,cc,aa,dd,image11, alpha);
% second triangle (left)
[frame_buffer,z_buffer, alpha_ch] = tri_scan_conv_Z_text_pros( d(1:3)', c(1:3)',b(1:3)' ,dh, ch, bh,  frame_buffer, z_buffer ,alpha_ch,bb,aa,dd,image11, alpha);
...
frame_buffer = flipdim(frame_buffer ,1);
alpha_ch = flipdim(alpha_ch ,1);
ffx = imshow(uint8(frame_buffer));
set(ffx, 'AlphaData', alpha_ch);
set(gcf, 'Color', 'w')
