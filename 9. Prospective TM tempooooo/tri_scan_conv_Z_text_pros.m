function [ frame_out,z_out,alpha_ch_out ] = tri_scan_conv_Z_text_pros( x1, y1, z1, h0, h1, h2, frame_in, Z_buffer,alpha_ch,aa,bb,cc,image,  alpha )
    ...
    for i=xx_min:xx_max
        ...
        if(Alpha>=0 && Beta>=0 && Gamma >=0)
            ...
            if(depth < Z_buffer(j,i))
                ...
                alpha_val =bi_linear(text_cord(1),text_cord(2), alpha);
