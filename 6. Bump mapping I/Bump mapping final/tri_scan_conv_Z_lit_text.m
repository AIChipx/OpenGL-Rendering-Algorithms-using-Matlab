function [ frame_out ] = tri_scan_conv_Z_lit_text( x1, y1, z1, normal,viewport_pos, frame_in , material_prop ,light_prop ,L,p, textcoord_x, textcoord_y, textcoord_z ,normal_map)
