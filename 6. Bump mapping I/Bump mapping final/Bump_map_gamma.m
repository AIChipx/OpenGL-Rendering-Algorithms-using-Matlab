...
normal_map = rescale_it(double(imread('normal_map_4.png')));
...
[Frame_buffer] = tri_scan_conv_Z_lit_2text( a3(1:3)', a1(1:3)', a2(1:3)' , viewport_pos, Frame_buffer, material_prop ,light_prop ,L,p, textcoord_a3, textcoord_a1, textcoord_a2, normal_map, texture_image);
[Frame_buffer] = tri_scan_conv_Z_lit_2text( a3(1:3)', a4(1:3)', a2(1:3)' , viewport_pos, Frame_buffer, material_prop ,light_prop ,L,p, textcoord_a3, textcoord_a4, textcoord_a2, normal_map, texture_image);
...
imwrite(f.cdata,'Frame_bufferxx4.png');   %# Save the frame data
